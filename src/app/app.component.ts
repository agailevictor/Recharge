...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen, public loadingCtrl: LoadingController) {
    ...
    this.pages = [
      { title: 'Profile', component: HomePage, menuicon : 'contact' },
      { title: 'Reload', component: ReloadPage, menuicon : 'card' },
      { title: 'Pay', component: DetailPage, menuicon : 'cash' },
      { title: 'Logout', component: LogoutPage, menuicon : 'exit' }
    ];
